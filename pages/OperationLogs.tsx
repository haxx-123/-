...
import { Filter, RotateCcw, AlertTriangle, Search, X, Calendar, User as UserIcon, Tag, ScanLine, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    return (
        <div className="flex items-center justify-end gap-2 mt-4 pt-2 border-t dark:border-gray-700">
            ...
            <div className="flex items-center gap-1 bg-gray-100 dark:bg-gray-700 rounded px-2 py-0.5">
                <input 
                    className="w-6 bg-transparent text-center outline-none text-xs font-bold" 
                    value={inputVal} 
        ...
        {paginatedLogs.length > 0 ? (
            ...
            <thead className="bg-gray-50 dark:bg-gray-900/50">
                <tr>
                    ...
                    {!isMobile && <th className="p-4">对象ID</th>}
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                {paginatedLogs.map(log => {
                    ...
                    <tr key={log.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        ...
                        <td className="p-4"><div className="font-medium text-gray-800 dark:text-gray-200">{renderChangeDesc(log)}</div></td>
                        {!isMobile && <td className="p-4 text-sm text-gray-500">{log.target_id.substring(0,8)}...</td>}
